          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join With Us Today & Start Posting Jobs !
              </h2>
              <p>
              Empowering Recruiters with Exceptional Talent Discovery, Elevating Your Team with Every Strategic Hire.
              </p>
            </motion.div>
            <motion.div
              variants={{
            ...
            >
              <div className="flex items-center justify-end xl:justify-between">
                ...
                <a
                  href="signup.html"
                  className="inline-flex items-center gap-2.5 rounded-lg bg-black px-6 py-3 font-medium text-white hover:opacity-90 dark:bg-white dark:text-black"
                >
                  Sign up free
                  <Image
                    width={20}
