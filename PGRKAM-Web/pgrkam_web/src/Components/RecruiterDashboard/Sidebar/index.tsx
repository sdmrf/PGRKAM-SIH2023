    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <button
          ...
          className="width-50 height-50 bg-hidden ml-3 flex items-center justify-center rounded-sm border-none border-stroke1 p-1 hover:bg-graydark dark:border-strokedark dark:bg-boxdark dark:hover:bg-graydark"
        >
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/Dashboard/Recruiter-dashboard"
