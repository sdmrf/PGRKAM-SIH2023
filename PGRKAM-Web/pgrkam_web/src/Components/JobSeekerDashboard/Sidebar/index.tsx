    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <button
          ...
          className="width-50 height-50 ml-3 flex items-center justify-center rounded-sm border-none border-stroke1 bg-hidden p-1 hover:bg-graydark dark:border-strokedark dark:bg-boxdark dark:hover:bg-graydark"
        >
          <MenuIcon className="text-bodydark1  dark:text-bodydark1" />
        </button>
      </div>
      {/* <!-- SIDEBAR HEADER --> */}
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/Homepage/Dashboard/Jobseeker-Dashboard"
              ...
              <li>
                <Link
                  href="/Homepage/Dashboard/FindJobs"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              <li>
                <Link
                  href="/Homepage/Dashboard/MyProfile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              <li>
                ...
                >
                  <CorporateFareIcon className="fill-current" />
                  Browse Comapnies
                </Link>
              </li>
              {/* <!-- Menu Item Settings --> */}
